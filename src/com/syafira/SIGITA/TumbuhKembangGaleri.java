...
public class TumbuhKembangGaleri extends TumbuhKembang {
        ...
        if (session.checkSession(this)) {
            ...
            ProfilLinearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent profil = new Intent(TumbuhKembangGaleri.this, Profil.class);
            ...
            // Set Text
            int id = Integer.parseInt(session.loadSession(TumbuhKembangGaleri.this, "id"));
            String nama = session.loadSession(TumbuhKembangGaleri.this, "nama");
            ...
            grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView parent, View v, int position, long id) {
                    ...
                    // Tambah Galeri
                    if (position == 0) {
                        Intent tambah_galeri = new Intent(TumbuhKembangGaleri.this, TumbuhKembangGaleriTambah.class);
                        lastActivity = System.currentTimeMillis();
                        ...
                        Intent detail_galeri = new Intent(TumbuhKembangGaleri.this, TumbuhKembangGaleriDetail.class);
                        lastActivity = System.currentTimeMillis();
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(TumbuhKembangGaleri.this);
            ...
            if (session.checkSession(this)) {
                ...
                Intent tumbang = new Intent(TumbuhKembangGaleri.this, TumbuhKembang.class);
                lastActivity = System.currentTimeMillis();
                tumbang.putExtra("lastActivity", lastActivity);
                tumbang.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(tumbang);
