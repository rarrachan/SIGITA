...
public class RekamMedisDetail extends RekamMedis {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_ubah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent ubah_medis = new Intent(RekamMedisDetail.this, RekamMedisUbah.class);
        ...
        button_hapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Create Dialog
                final Dialog dialog = new Dialog(RekamMedisDetail.this);
                ...
                button_ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent hapus_medis = new Intent(RekamMedisDetail.this, RekamMedisHapus.class);
                        hapus_medis.putExtra("id", medisID);
                        hapus_medis.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(hapus_medis);
                        // Close This Activity
                        finish();
    ...
    public void onBackPressed() {
        ...
        // Show Rekam Medis Activity
        Intent medis = new Intent(RekamMedisDetail.this, RekamMedis.class);
        lastActivity = System.currentTimeMillis();
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(RekamMedisDetail.this);
