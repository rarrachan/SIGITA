...
public class GiziDokumentasiDetail extends GiziDokumentasi {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BBUChartSeluruhBulan = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, BBUdatasetSeluruhBulan, BBUmultiRenderer);
        BBUChartBulanIni = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, BBUdatasetBulanIni, BBUmultiRenderer);
        ...
        // Creating a Line Chart
        TBUChartSeluruhBulan = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, TBUdatasetSeluruhBulan, TBUmultiRenderer);
        TBUChartBulanIni = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, TBUdatasetBulanIni, TBUmultiRenderer);
        ...
        // Creating a Line Chart
        BBTBChartSeluruhBulan = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, BBTBdatasetSeluruhBulan, BBTBmultiRenderer);
        BBTBChartBulanIni = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, BBTBdatasetBulanIni, BBTBmultiRenderer);
        ...
        // Creating a Line Chart
        IMTUChartSeluruhBulan = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, IMTUdatasetSeluruhBulan, IMTUmultiRenderer);
        IMTUChartBulanIni = ChartFactory.getLineChartView(GiziDokumentasiDetail.this, IMTUdatasetBulanIni, IMTUmultiRenderer);
        ...
        button_ubah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Show Ubah Dokumentasi Activity
                Intent ubah_dokumentasi = new Intent(GiziDokumentasiDetail.this, GiziDokumentasiUbah.class);
                // Put Intent Extra
        ...
        button_hapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button_ok.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        // Show Hapus Dokumentasi Activity
                        Intent hapus_dokumentasi = new Intent(GiziDokumentasiDetail.this, GiziDokumentasiHapus.class);
                        // Put Intent Extra
                        hapus_dokumentasi.putExtra("dokumentasiID", dokumentasiID);
                        hapus_dokumentasi.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(hapus_dokumentasi);
                        finish();
    ...
    public void onBackPressed() {
        Intent gizi = new Intent(this, GiziDokumentasi.class);
        lastActivity = System.currentTimeMillis();
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(GiziDokumentasiDetail.this);
