...
public class ImunisasiJadwal extends Imunisasi{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProfilLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profil = new Intent(ImunisasiJadwal.this, Profil.class);
        ...
        if (!cursor.isAfterLast()) {
            do {
                ...
                detail.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // Show Detail Profil Activity
                        Intent detail_imunisasi = new Intent(ImunisasiJadwal.this, ImunisasiJadwalDetail.class);
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(ImunisasiJadwal.this);
