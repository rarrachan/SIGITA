...
public class ProfilTambah extends Profil implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.profil_foto:
                ...
                // Create Dialog
                AlertDialog.Builder builder = new AlertDialog.Builder(ProfilTambah.this);
            ...
            case R.id.profil_tanggallahir:
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(ProfilTambah.this, new DatePickerDialog.OnDateSetListener() {
            ...
            case R.id.button_simpan:
                ...
                if (TextUtils.isEmpty(nama) ) {
                    ...
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Kolom Panjang Lahir Belum Terisi", Toast.LENGTH_SHORT).show();

                } else if (TextUtils.isEmpty(beratLahir)) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Kolom Berat Lahir Belum Terisi", Toast.LENGTH_SHORT).show();

                } else if (TextUtils.isEmpty(tmptLahir)) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Kolom Tempat Lahir Belum Terisi", Toast.LENGTH_SHORT).show();

                } else if (TextUtils.isEmpty(tglLahir)) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Kolom Tanggal Lahir Belum Terisi", Toast.LENGTH_SHORT).show();

                } else if (profil_jeniskelamin.getCheckedRadioButtonId() == -1) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Kolom Jenis Kelamin Belum Terisi", Toast.LENGTH_SHORT).show();

                } else if (profil_golongandarah.getCheckedRadioButtonId() == -1) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Kolom Golongan Darah Belum Terisi", Toast.LENGTH_SHORT).show();

                } else if (Float.parseFloat(panjangLahir) < 45) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Panjang Lahir Tidak Boleh Kurang Dari 45 cm", Toast.LENGTH_SHORT).show();

                }  else if (Float.parseFloat(panjangLahir) > 120) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Panjang Lahir Tidak Boleh Lebih Dari 120 cm", Toast.LENGTH_SHORT).show();

                } else if (Float.parseFloat(beratLahir) < 2) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Berat Lahir Tidak Boleh Kurang Dari 2 kg", Toast.LENGTH_SHORT).show();

                } else if (Float.parseFloat(beratLahir) > 30) {
                    // Show Toast
                    Toast.makeText(ProfilTambah.this, "Berat Lahir Tidak Boleh Lebih Dari 30 kg", Toast.LENGTH_SHORT).show();
                    ...
                    if (Environment.MEDIA_MOUNTED.equals(state)) {
                        ...
                        try {
                            ...
                            // Scan Gallery
                            MediaScannerConnection.scanFile(ProfilTambah.this,
                    ...
                    Intent profil = new Intent(ProfilTambah.this, Profil.class);
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(ProfilTambah.this);
