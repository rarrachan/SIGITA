...
public class ImunisasiRiwayatUbah extends ImunisasiRiwayatDetail {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(0, "Pilih");
        final ArrayAdapter dataAdapter = new ArrayAdapter<String>(ImunisasiRiwayatUbah.this, android.R.layout.simple_spinner_item, list) {
            public View getView(int position, View convertView, ViewGroup parent) {
                TextView v = (TextView) super.getView(position, convertView, parent);
                v.setTypeface(typeface);
                v.setTextAppearance(ImunisasiRiwayatUbah.this, android.R.style.TextAppearance_DeviceDefault_Medium);
        ...
        riwayat_tanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String getBirthdayDate = session.loadSession(ImunisasiRiwayatUbah.this, "tanggallahir");

                // Create Dialog DataPicker
                final DatePickerDialog mDatePicker = new DatePickerDialog(ImunisasiRiwayatUbah.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    /*      Your code   to get date and time    */
                        ...
                        String getBirthdayDate = session.loadSession(ImunisasiRiwayatUbah.this, "tanggallahir");
        ...
        button_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Get Value
                int profilID = Integer.parseInt(session.loadSession(ImunisasiRiwayatUbah.this, "id"));
                ...
                if (TextUtils.isEmpty(tanggal) ) {
                    //Show Toast
                    Toast.makeText(ImunisasiRiwayatUbah.this, "Kolom Tanggal Vaksinasi Belum Terisi", Toast.LENGTH_SHORT).show();
                } else if (riwayat_jenisvaksin.getSelectedItemPosition() == 0) {
                    //Show Toast
                    Toast.makeText(ImunisasiRiwayatUbah.this, "Kolom Jenis Vaksinasi Belum Terpilih", Toast.LENGTH_SHORT).show();
                } else {
                    // Declare Condition
                    ...
                    Intent detail_riwayat = new Intent(ImunisasiRiwayatUbah.this, ImunisasiRiwayatDetail.class);
    ...
    public void onBackPressed() {
        ...
        Intent detail_riwayat = new Intent(this, ImunisasiRiwayatDetail.class);
        lastActivity = System.currentTimeMillis();
        detail_riwayat.putExtra("lastActivity", lastActivity);
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(ImunisasiRiwayatUbah.this);
