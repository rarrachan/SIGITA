...
public class ImunisasiAlarmReceiver extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent cancelIntent = PendingIntent.getActivity(context, IDs, new Intent(context, ImunisasiAlarm.class), 0);
        cancelIntent.cancel();

        // notification builder
        Notification.Builder nb = new Notification.Builder(context)
                .setContentTitle(alarm_nama)
                .setContentText("Imunisasi " + alarm_vaksin.replaceAll("\n", ", ") + " Pada " + alarm_bulan)
                .setAutoCancel(true)
