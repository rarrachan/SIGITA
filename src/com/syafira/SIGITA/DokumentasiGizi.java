...
public class DokumentasiGizi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load Layout
        setContentView(R.layout.dokumentasi_gizi);
                ...
                do {
                    ...
                    detail.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent detail_dokumentasi = new Intent(DokumentasiGizi.this, DetailDokumentasi.class);
        ...
        ProfilLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Show Detail Profil Activity
                Intent profil = new Intent(DokumentasiGizi.this, Profil.class);
                lastActivity = System.currentTimeMillis();
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            if (session.checkSession(this)) {
                ...
                // Start Home Activity
                Intent index = new Intent(DokumentasiGizi.this, Home.class);
                lastActivity = System.currentTimeMillis();
