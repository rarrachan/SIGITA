...
public class TumbuhKembangTahapan extends TumbuhKembang {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProfilLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profil = new Intent(TumbuhKembangTahapan.this, Profil.class);
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(TumbuhKembangTahapan.this);
