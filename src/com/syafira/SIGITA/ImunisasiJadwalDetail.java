...
public class ImunisasiJadwalDetail extends ImunisasiJadwal {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load Layout
        setContentView(R.layout.imunisasi_jadwalimunisasi_detail);
        ...
        ProfilLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent profil = new Intent(ImunisasiJadwalDetail.this, Profil.class);
    ...
    public void onBackPressed() {
        ...
        Intent jadwal_imunisasi = new Intent(this, ImunisasiJadwal.class);
        lastActivity = System.currentTimeMillis();
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(ImunisasiJadwalDetail.this);
