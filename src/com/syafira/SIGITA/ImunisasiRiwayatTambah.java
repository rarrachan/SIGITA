...
public class ImunisasiRiwayatTambah extends ImunisasiRiwayat {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(0, "Pilih");
        ArrayAdapter dataAdapter = new ArrayAdapter<String>(ImunisasiRiwayatTambah.this, android.R.layout.simple_spinner_item, list) {
            public View getView(int position, View convertView, ViewGroup parent) {
                TextView v = (TextView) super.getView(position, convertView, parent);
                v.setTypeface(typeface);
                v.setTextAppearance(ImunisasiRiwayatTambah.this, android.R.style.TextAppearance_DeviceDefault_Medium);
        ...
        riwayat_tanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String getBirthdayDate = session.loadSession(ImunisasiRiwayatTambah.this, "tanggallahir");

                // Create Dialog DataPicker
                final DatePickerDialog mDatePicker = new DatePickerDialog(ImunisasiRiwayatTambah.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    /*      Your code   to get date and time    */
                        ...
                        String getBirthdayDate = session.loadSession(ImunisasiRiwayatTambah.this, "tanggallahir");
        ...
        button_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Get Value
                int profilID = Integer.parseInt(session.loadSession(ImunisasiRiwayatTambah.this, "id"));
                ...
                if (TextUtils.isEmpty(tanggal) ) {
                    //Show Toast
                    Toast.makeText(ImunisasiRiwayatTambah.this, "Kolom Tanggal Vaksinasi Belum Terisi", Toast.LENGTH_SHORT).show();
                } else if (riwayat_jenisvaksin.getSelectedItemPosition() == 0) {
                    //Show Toast
                    Toast.makeText(ImunisasiRiwayatTambah.this, "Kolom Jenis Vaksinasi Belum Terpilih", Toast.LENGTH_SHORT).show();
                } else {
                    // Declare Condition
                    ...
                    Intent riwayat = new Intent(ImunisasiRiwayatTambah.this, ImunisasiRiwayat.class);
    ...
    public void onResume() {
        ...
        if (lastActivity < now) {
            ...
            // Clear Session
            session.clearSession(ImunisasiRiwayatTambah.this);
